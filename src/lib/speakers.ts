/** Day 8: speaker profiles for colored caption lines (1–4). */
...
export const SPEAKERS: SpeakerProfile[] = [
  ...
  { id: 2, name: 'Speaker 2', bgColor: '#22c55e', textColor: '#111827' },
  { id: 3, name: 'Speaker 3', bgColor: '#eab308', textColor: '#111827' },
  { id: 4, name: 'Speaker 4', bgColor: '#f97316', textColor: '#111827' },
];
